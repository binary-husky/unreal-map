...
conf_override = {
    "config.py->GlobalConfig-->note":       
                [
                    "HistoryRolling(10itf) rx2",
                    "HistoryRolling(20itf) rx2",
                    "HistoryRolling(30itf) rx2",

                    "HistoryRolling(40itf) rx2",
                    "HistoryRolling(50itf) rx2",
                    "HistoryRolling(60itf) rx2",

                    "HistoryRolling(70itf) rx2",
                    "HistoryRolling(80itf) rx2",
                    "HistoryRolling(90itf) rx2",
                ],
