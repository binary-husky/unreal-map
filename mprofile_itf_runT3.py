...
conf_override = {
    "config.py->GlobalConfig-->note":       
                [
                    "train_origin_T(10itf) rx4",
                    "train_origin_T(20itf) rx4",
                    "train_origin_T(30itf) rx4",

                    "train_origin_T(40itf) rx4",
                    "train_origin_T(50itf) rx4",
                    "train_origin_T(60itf) rx4",

                    "train_origin_T(70itf) rx4",
                    "train_origin_T(80itf) rx4",
                    "train_origin_T(90itf) rx4",
                ],
