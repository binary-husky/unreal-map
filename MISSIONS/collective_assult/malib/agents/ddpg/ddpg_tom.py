...
class DDPGToMAgent(OffPolicyAgent):
    def __init__(self,
                 env_specs,
                 policy,
                 qf,
        ...
        super(DDPGToMAgent, self).__init__(
            observation_space,
            action_space,
            policy,
            qf,
    ...
    def critic_loss(self,
        ...
        target_actions = self._target_policy.get_actions_np([next_observations, target_opponent_actions])
    ...
    def actor_loss(self, observations, opponent_actions, weights=None):
        opponent_actions = self._opponent_policy.get_actions_np(observations)
