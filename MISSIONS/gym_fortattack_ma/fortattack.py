...
def make_fortattack_env(args, num_steps, benchmark=False):
    # scenario = gym.make('fortattack-v1')
    scenario = FortAttackEnvV1(numguards=args.num_guards, numattackers = args.num_attackers, size=args.size)
    # create world
